...
You are not allowed to search for security vulnerabilities on any hosted service of Reposeed Server without the consent of the party hosting it.
Reposeed Server is open source software and can be installed for testing and security issues on your own infrastructure.
